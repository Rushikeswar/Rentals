    ...
    <div className='dashboard-container'>
      <div className='dashboard-menu'>
        ...
        <ul>
          ...
          <li className="options"><NavLink to='/managerpage/uploadnotifications'>Upload NOTIFICATIONS</NavLink></li>
          <li className="options"><NavLink to='/managerpage/Bookingnotifications'>Booking NOTIFICATIONS</NavLink></li>
